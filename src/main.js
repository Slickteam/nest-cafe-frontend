...
import { initKeycloak, keycloak, KEYCLOAK_USER_ATTRIBUE } from '@/utils/keycloak.js';
  ...
  .then(() => {
    ...
    if (keycloak.authenticated) {
      ...
      userStore.setUserInfo({
        ...
        preferred_username: keycloak.idTokenParsed[KEYCLOAK_USER_ATTRIBUE.preferred_username],
